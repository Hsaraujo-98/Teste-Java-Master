 ...
 * classe. Aqui estamos implementando m?todos básicos para adição, update e
 * delete físico. Se necessário sobrescreva os m?todos na sua service.
 *
 * @param <T> entidade
...
public abstract class AbstractGenericServicePersistence<D extends JpaRepository<T, I>, T extends GenericEntity<I>, I extends Serializable>
	...
	public T update(T t) {
		if (t.getId() != null) {
			...
			throw new UnsupportedOperationException("Esse objeto não possui um id, realize um save.");
	}
